...
import Sally from "./images/sally.png"; // Assuming your login image is stored in the images folder
import Logo from "./images/panasonic.jpg";
        ...
        <div className="self-center pr-30 mt-6 w-full max-w max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            ...
            <div className="flex flex-col ml-5 w-[37%] max-md:ml-0 max-md:w-full">
              <form className="flex flex-col text-base text-indigo-300 max-md:mt-10 relative z-10">
